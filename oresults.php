...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <li><a href="oorganizers.php"><i class='bx bxs-folder-open'></i><span class="text">Organizers</span></a></li>
            <li class="active"><a href="oresults.php"><i class='bx bxs-doughnut-chart'></i><span class="text">Results</span></a></li>
        </ul>
