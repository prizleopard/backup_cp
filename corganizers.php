...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <li><a href="cmessage.php"><i class='bx bxs-message-dots'></i><span class="text">Message</span></a></li>
            <li><a href="cnewsfeed.php"><i class='bx bx-spreadsheet'></i><span class="text">News Feed</span></a></li>
            <li class="active"><a href="corganizers.php"><i class='bx bxs-folder-open'></i><span class="text">Organizers</span></a></li>
